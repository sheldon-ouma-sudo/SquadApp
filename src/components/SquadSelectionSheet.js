...
const SquadSelectionSheet = ({ onClose, onSquadsSelected }) => {
  ...
  const bottomSheetModalRef = useRef(null);  // ref to control the modal
  ...
  return (
    <BottomSheetModalProvider>
      <BottomSheetModal
        ref={bottomSheetModalRef}  // Attach the ref to the BottomSheetModal
